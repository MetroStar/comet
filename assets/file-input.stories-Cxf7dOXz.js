import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{R as n}from"./iframe-BIDTTI5V.js";import{t as r}from"./jsx-runtime-CaZkqeYb.js";import{t as i}from"./button-BXMzzADO.js";import{a,i as o,o as s,r as c,t as l}from"./hooks-O4Dadocc.js";var u,d,f,p,m,h,g;e((()=>{u=t(n()),a(),l(),s(),d=r(),f={title:`USWDS/Forms/File Input`,component:o,argTypes:{id:{required:!0},name:{required:!0},multiple:{type:`boolean`},required:{control:`boolean`},disabled:{control:`boolean`}}},p={args:{id:`file-input-1`,name:`file-input-1`,multiple:!1,required:!1,label:`Select a file`,helperText:`Input accepts a single file`,disabled:!1},render:e=>(0,d.jsx)(o,{...e})},m={args:{id:`file-input-2`,name:`file-input-2`,multiple:!0,required:!1,label:`Select files`,helperText:`Input accepts multiple files`,disabled:!1},render:e=>(0,d.jsx)(o,{...e})},h={args:{id:`file-input-1`,name:`file-input-1`,multiple:!1,required:!1,label:`Select a file`,helperText:`Input accepts a single file`,disabled:!1},render:e=>{let{clear:t}=c(),[n,r]=(0,u.useState)(null);return(0,u.useEffect)(()=>{console.log(n)},[n]),(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(`div`,{className:`padding-bottom-1`,children:(0,d.jsx)(o,{onChange:e=>{let t=e.target?.files;t&&r(t[0])},...e})}),(0,d.jsx)(`div`,{children:(0,d.jsx)(i,{id:`clear-btn`,onClick:()=>{t(e.id),r(null)},children:`Clear`})})]})},parameters:{docs:{source:{type:`code`}}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
    id: 'file-input-1',
    name: 'file-input-1',
    multiple: false,
