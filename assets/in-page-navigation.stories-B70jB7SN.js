import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./react-BZJXY1be.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{g as r,t as i}from"./src-Bj2RX8sU.js";var a,o,s,c,l;function u(){return(u=e((()=>{t(),i(),a=n(),o={title:`USWDS/In-Page Navigation`,component:r,argTypes:{id:{required:!0}}},s=`
...
`,c={args:{id:`nav-1`,navTitle:`On this page`,pageTitle:`Sample in-page navigation page`,items:[{heading:`Lorem ipsum dolor`,content:s,headingType:`h2`},{heading:`Consectetuer adipiscing elit`,content:s,headingType:`h2`},{heading:`Nullam sit amet enim`,content:s,headingType:`h3`},{heading:`Vivamus pharetra posuere sapien`,content:s,headingType:`h3`},{heading:`Suspendisse id velit`,content:s,headingType:`h2`}]},render:e=>(0,a.jsx)(r,{...e})},l=[`Default`],c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    id: 'nav-1',
...
}`,...c.parameters?.docs?.source}}}})))()}u();export{c as Default,l as __namedExportsOrder,o as default};